...
def manage_request(firewall_parameter, ids_parameter, bins, live_cache, glob_data_fir, glob_data_ids, mode, start=None, end=None):   
    ...
    return ch.get_latest_hist(fir_str=firewall_parameter, ids_str=ids_parameter, bins=bins, live_cache=live_cache["hist"], glob_data_fir=glob_data_fir, glob_data_ids=glob_data_ids, mode=mode, start=start, end=end)
